...
export function ComparisonView({
  ...
  return (
    <Card className={cn('rounded-(--radius)', className)}>
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="space-y-2">
        ...
        <div className="h-[200px] overflow-auto rounded-(--radius) border bg-muted/30 p-3 transition-all duration-200">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="min-h-[100px] max-h-[200px] overflow-auto rounded-(--radius) border bg-muted/30 p-3 transition-all duration-200">
          <pre className="whitespace-pre-wrap text-xs font-mono">
            {originalPrompt}
          </pre>
        </div>
